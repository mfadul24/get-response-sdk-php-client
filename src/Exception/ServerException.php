...
{
    final const SERVER_ERROR_MSG = 'server error: server is temporarily unavailable, please contact our support. Please see response body for request uuid and paste it in support ticket, this uuid will help us find Your request in our logs';
